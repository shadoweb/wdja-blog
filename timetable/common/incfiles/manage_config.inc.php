...
function wdja_cms_admin_manage_adddisp()
{
  ...
  $ttype = ii_format_checkData($_POST['type'],',','0');//未选择时默认为0
  ...
  '" . $ttype . "',
  " . ii_get_num($_POST['week']) . ",
  " . ii_get_num($_POST['day']) . ",
  '" . $start_time . "',
  '" . $end_time . "',
...
function wdja_cms_admin_manage_editdisp()
{
  ...
  " . ii_cfname('week') . "=" . ii_get_num($_POST['week']) . ",
  " . ii_cfname('day') . "=" . ii_get_num($_POST['day']) . ",
  " . ii_cfname('start_time') . "='" . $start_time . "',
  " . ii_cfname('end_time') . "='" . $end_time . "',
